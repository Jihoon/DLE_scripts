...
load(file="H:/MyDocuments/IO work/DLE_scripts/Saved tables/IND.food.tfei.Jul2018.Rda")
...
kcal.ssp2 = read_excel("C:/Users/min/IIASA/DLE - Documents/WS2 - Documents/Analysis/IO/DLE trajectory/SSP_projection_Valin_BICS_2015.xlsx",
                      sheet="Data") %>% 
