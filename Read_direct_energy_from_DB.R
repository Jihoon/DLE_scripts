...
p_petrol2007 <- 43 / PPP_IND * CPI_ratio  # 2007 rupees per litre -> 2010 ppp$/litre
p_diesel2007 <- 30.4 / PPP_IND * CPI_ratio

# fuel_p Returns NA
fuel_p = WDI(country = "IN", indicator = c("EP.PMP.SGAS.CD", "EP.PMP.DESL.CD"), start = 2007, end = 2007, extra = FALSE, cache = NULL)
